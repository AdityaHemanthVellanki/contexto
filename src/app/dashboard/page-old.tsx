...
import { Upload, FileText, Brain, Database, MessageSquare, CheckCircle, XCircle, Clock, AlertCircle, Plus, Folder, Search } from 'lucide-react';

// Type definitions for MCP management
interface MCPItem {
  id: string;
  title: string;
  fileName: string;
